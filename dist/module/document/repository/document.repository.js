...
let DocumentRepository = class DocumentRepository extends generic_postgres_repository_1.GenericRepository {
    constructor(prismaService) {
        super(prismaService, entity_name_constant_1.ENTITY_NAME.DOCUMENT);
